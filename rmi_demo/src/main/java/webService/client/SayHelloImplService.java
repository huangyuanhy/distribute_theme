 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://webService_demo/", wsdlLocation = "http://localhost:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://webService_demo/", "SayHelloImplService");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://webService_demo/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webService_demo/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
